...
namespace LegacyApplication.Database.Context
{
    public class CoreContext : DbContext, IUnitOfWork
    {
        ...
        //LI
        public DbSet<LightInfo> LightInfos { get; set; }
        public DbSet<TeleInfo> TeleInfos { get; set; }
        public DbSet<GroupInfo> GroupInfos { get; set; }
        public DbSet<GroupLightInfo> GroupLightInfos { get; set; }
        public DbSet<TempTimeSchMain> TempTimeSchMains { get; set; }
        public DbSet<TempTimeSchDetail> TempTimeSchDetails { get; set; }
        public DbSet<LightSchMain> LightSchMains { get; set; }
        public DbSet<LightSchDetail> LightSchDetails { get; set; }
        public DbSet<LightAlarm> LightAlarms { get; set; }
    }
}